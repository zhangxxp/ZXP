    ...
    layui.use(['table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'name', title: '咨询类别', width:80,edit: 'text'}
                ,{field:'state', title: '咨询状态', width:100 ,templet:"#switchTpl"}
        ...
        table.on('tool(user)', function(obj){
            ...
            if(obj.event === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.ajax({
                        type:"get",
                        url:"/sadvisory/delete?id="+data.id,
                        data:{},
                        success:function (result) {
                            if (result.code == 0){
                                //从表格删除
        ...
        $("#add").click(function () {
            layer.open({
                ...
                ,shadeClose:true
                ,content: "/pages/sem/dept/advisorysave.jsp"
                ,yes:function (index) {
                    layer.close(index);
                }
